...
echo "    cmd: /app/vendor/bin/drush --root=/app/web --uri=https://$appName.lndo.site" >> .lando.yml
...
lando composer create-project drupal/recommended-project:^10 drupal10 --no-interaction
mv drupal10/{.[!.],}* .
rm -rf drupal10
